...
# conda create -c conda-forge -c bioconda --prefix=/project/lbarreiro/USERS/austin/envs/slamseq_v2 snakemake snakemake-executor-plugin-slurm snakemake-storage-plugin-http fastp fastqc hisat-3n samtools bedtools kallisto=0.50.1 openjdk multiqc
